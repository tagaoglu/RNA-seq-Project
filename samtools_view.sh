...
#SBATCH --output=/data/courses/rnaseq/toxoplasma_de/tagaoglu/messages_output/output_samtools_view_%j.o
#SBATCH --error=/data/courses/rnaseq/toxoplasma_de/tagaoglu/messages_error/error_samtools_view_%j.e
#SBATCH --array=0-3
...
mkdir /data/courses/rnaseq/toxoplasma_de/tagaoglu/2_map_reads/bam_files
cd /data/courses/rnaseq/toxoplasma_de/tagaoglu/2_map_reads



# Convert sam to bam with samtools
samtools view -hbS hisat2_mapping/${SAMPLES[$SLURM_ARRAY_TASK_ID]}.sam > bam_files/${SAMPLES[$SLURM_ARRAY_TASK_ID]}.bam
